  ...
  {blogs.map((blog, index) => (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden rounded-t-2xl">
        ...
        <div className="absolute bottom-2 left-3 right-3 text-white font-semibold text-lg drop-shadow-md line-clamp-2">
          {blog.title}
        </div>
      </div>
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {/* Description */}
        <p className={`line-clamp-3 mb-3 flex-grow text-sm ${dark ? "text-gray-300" : "text-gray-700"}`}>
        ...
        <Link
          to={`/blogs/${blog._id}`}
          className={`mt-auto btn border-2 px-4 py-2 rounded-lg font-semibold transition duration-300 text-center ${
            dark
